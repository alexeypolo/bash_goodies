...
" Highlight tags, generated by Exuberant ctags
" C++ example:
"   (ctags --exclude="*.js*" --c++-kinds=cgnstu -o- -R src) | awk '{printf("syntax keyword Type\t%s\n", $1)}' > types.vim
" Highlight tags (created by Exuberant ctags)
